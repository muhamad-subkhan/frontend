...
function AddFilm() {
  return (
    <Form className="container pt-5">
      ...
      <Row className="mb-3">
        <Col sm={10}>
          <Form.Control placeholder="title" style={{ background: "#343434" }} />
        </Col>
        <Col sm={2}>
          <>
            <label
            ...
            >
              Attach Thumbnail
              <IoMdAttach className="ms-2" style={{color: "red", fontSize: "22px"}} />
            </label>
      ...
      />
        ...
        <Dropdown className="mb-3">
              <Dropdown.Toggle id="dropdown-basic" className="d-flex justify-content-between text-muted">
                   Category

                   <BsFillCaretDownFill className="pt-1 fs-3" style={{background:"transparent"}}/>
                  </Dropdown.Toggle>
